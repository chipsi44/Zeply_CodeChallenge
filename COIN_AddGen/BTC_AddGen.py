...
def bitcoin_address_generator(private_key) :
    if private_key : 
        ...
        generated_privateKey = wallet.address.__dict__['key'].__str__().split("\n")
        generated_privateKey = generated_privateKey[1].split(" ")[-1]
        return_privateKey = generated_privateKey
